...
<p>
 ...
 <ol>
   ...
   <li><h4>EXTRACT FILES TO C:\USERS\<USERNAME>\KALIFTW</h4><br> This step is self explainatory</li>
   <li><h4>RUN "Kali FTW Install.exe" AS ADMIN</h4><br>... And so is this step.</li>
